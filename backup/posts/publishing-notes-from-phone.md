...
title: "从手机发一条短文"
description: "静态博客不必换成 CMS，快捷指令直接调 GitHub API 就够了。"
aiGenerated: true
updates:
  ...
  - datetime: "2026-07-28 15:50"
    action: 修改
    note: "精简 description 至一行；一处「文末更新记录」改为「更新记录」"
    agent: "Claude Code 2.1.220 / claude-opus-5"
  - datetime: "2026-07-29 09:38"
    action: 修改
    note: "补充图片相关内容：两次有序请求、端上压缩、画廊显示、srcset 的静默失效"
    agent: "Claude Code 2.1.220 / claude-opus-5"
---
